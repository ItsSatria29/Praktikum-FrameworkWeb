...
class BukuController extends Controller
{
    ...
    public function store(Request $request){
        ...
        return redirect()->intended('/buku')->with('success', 'Buku berhasil ditambahkan!');
    }
    ...
    public function update(Request $request, $id) {
        ...
        return redirect()->intended('/buku')->with('success', 'Buku berhasil diedit!');
    }

    public function destroy($id) {
        Buku::destroy($id);
        return redirect()->intended('/buku')->with('success', 'Buku berhasil dihapus!');
    }
}
